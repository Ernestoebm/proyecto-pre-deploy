...
const navigationPatient = [
  ...
  { name: 'Localidades', href: '/loca', current: false },
]
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 items-center justify-between">
                <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                  {/* Mobile menu button*/}
                  <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-black hover:bg-black hover:text-black focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black">
                          ...
                          ? navigationHealth.map((item) => (
                            <a
                              ...
                              className={classNames(
                                item.current ? 'bg-green-500 text-black' : 'text-black hover:bg-green-300 hover:text-black  ',
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  <button
                    type="button"
                    className="relative rounded-full bg-gray-800 p-1 text-black hover:text-black focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-800"
                  >
              ...
              <div className="space-y-1 px-2 pb-3 pt-2">
                {navigationPatient.map((item) => (
                  <Disclosure.Button
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-green-900 text-white' : 'text-black hover:bg-green-700 hover:text-white',
